...
# nohup torchrun --nproc_per_node=1 train_capacity_token_router.py 2>&1 | tee training.log
...
TOKENIZER_PATH = "/home/yanze/ML-Assignment(my_demo)/model/Qwen/Qwen2.5-7B-Instruct"
# 加载 tokenizer
...
def main():
    ...
    # 数据加载
    file_path = "/lustre/home/2300011115/train_token/router.jsonl"
    ...
    for epoch in range(10000):  # 按 epoch 来控制
        ...
        for step, batch in enumerate(dataloader):
            ...
            if step % 20 == 0 and local_rank == 0:
                ...
                print(f"[epoch {epoch} step {step}] loss: {loss.item():.16f}")
